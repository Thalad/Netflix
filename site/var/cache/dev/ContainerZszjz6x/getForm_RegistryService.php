...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\Register' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Register']) ? $this->services['AppBundle\Form\Register'] : $this->services['AppBundle\Form\Register'] = new \AppBundle\Form\Register()) && false ?: '_'};
