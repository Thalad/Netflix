...
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/FilmFixtures.php';
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/UserFixtures.php';
...
$a->addFixtures(array(0 => new \AppBundle\DataFixtures\FilmFixtures(), 1 => new \AppBundle\DataFixtures\UserFixtures()));
